...
const questionsAnswers = [
    ...
    { question: 'Колко ключа може да побере?', answer: 'Disney Keychains са проектирани да държат множество ключове на всеки ключодържател, което ги прави идеални както за малки, така и за големи ключодържатели. От 2 до 15 ключа.' },
